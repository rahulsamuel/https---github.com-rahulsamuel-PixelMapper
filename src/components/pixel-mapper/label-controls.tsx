        ...
        {showDimensions && (
          <div className="space-y-4 mt-4">
            <div className="space-y-2">
              ...
              <Select
                value={dimensionUnit}
                onValueChange={(v) => setDimensionUnit(v as 'mm' | 'meters' | 'inches' | 'decimal-feet' | 'feet-inches' | 'all')}
              >
                <SelectTrigger id="dimension-unit"><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">All (ft/in + mm)</SelectItem>
                  <SelectItem value="feet-inches">Feet/Inches (fractional)</SelectItem>
                  <SelectItem value="decimal-feet">Decimal Feet</SelectItem>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-mono">{Math.round(logoOverlay.width)}px</span>
              </div>
              <Slider
                value={[logoOverlay.width]}
                min={20}
                max={500}
                step={5}
          ...
          onChange={(e) => {
            ...
            reader.onload = (ev) => {
              ...
              img.onload = () => {
                ...
                const tileW = currentScreen.dimensions.tileWidth;
                const tileH = currentScreen.dimensions.tileHeight;
                const defaultX = (effectiveScreenWidth * tileW) - w - tileW;
                const defaultY = (effectiveScreenHeight * tileH) - h - tileH;
                setLogoOverlay({
